  ...
  <div class="mt-2 bg-neutral-900 border border-neutral-800 rounded p-4">
    ...
    <div class="space-y-2 text-sm">
      ...
      <div class="flex items-center gap-2">
        ...
        <input type="text" name="author_custom" value="<?php echo e($post['author_name']); ?>" class="flex-1 rounded-md bg-neutral-950 border border-neutral-800 px-3 py-2" placeholder="e.g., CyberBlog Editorial" />
      </div>
    </div>
  </div>
  <div class="grid md:grid-cols-3 gap-4">

...
<?php foreach($posts as $p): ?>
  <article class="bg-neutral-900 border border-neutral-800 rounded-lg overflow-hidden">
    <?php if(!empty($p['cover_image'])): ?><a href="<?php echo base_url('post/'.e($p['slug']));?>"><img class="w-full aspect-video object-cover" src="<?php echo e(upload_url($p['cover_image'])); ?>" alt=""></a><?php endif; ?>
    <div class="p-6">
